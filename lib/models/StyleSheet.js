...
var StyleSheet = function () {
  ...
  _createClass(StyleSheet, [{
    key: 'constructComponentTagMap',
    value: function constructComponentTagMap() {
      var _this = this;
    ...
    key: 'alreadyInjected',
    value: function alreadyInjected(hash, name) {
    ...
    key: 'hasInjectedComponent',
    value: function hasInjectedComponent(componentId) {
      return !!this.componentTags[componentId];
    }
  }, {
    key: 'deferredInject',
    value: function deferredInject(componentId, isLocal, css) {
      if (this === instance) {
    ...
    key: 'inject',
    value: function inject(componentId, isLocal, css, hash, name) {
      if (this === instance) {
        clones.forEach(function (clone) {
    ...
    key: 'getOrCreateTag',
    value: function getOrCreateTag(componentId, isLocal) {
    ...
    key: 'createNewTag',
    value: function createNewTag(isLocal) {
