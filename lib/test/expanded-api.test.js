...
describe('expanded api', function () {
  ...
  describe('chaining', function () {
    it('should merge the options strings', function () {
      ...
      expect((0, _enzyme.shallow)(_react2.default.createElement(Comp, null)).prop('className')).toBe('id-1 a');
    });
    ...
    it('should keep the last value passed in when merging', function () {
      ...
      expect((0, _enzyme.shallow)(_react2.default.createElement(Comp, null)).prop('className')).toBe('id-4 a');
    });
  });
});