...
var _templateObject = _taggedTemplateLiteral(['\n        color: blue;\n      '], ['\n        color: blue;\n      ']),
    ...
    _templateObject5 = _taggedTemplateLiteral(['color: green;'], ['color: green;']),
    _templateObject6 = _taggedTemplateLiteral(['\n        color: ', ';\n      '], ['\n        color: ', ';\n      ']),
    _templateObject7 = _taggedTemplateLiteral(['\n        body { color: tomato; }\n      '], ['\n        body { color: tomato; }\n      ']),
    _templateObject8 = _taggedTemplateLiteral(['color: tomato;'], ['color: tomato;']),
    _templateObject9 = _taggedTemplateLiteral(['\n        html { font-size: 16px; }\n      '], ['\n        html { font-size: 16px; }\n      ']),
    _templateObject10 = _taggedTemplateLiteral(['\n        body { background: papayawhip; }\n      '], ['\n        body { background: papayawhip; }\n      ']),
    _templateObject11 = _taggedTemplateLiteral(['\n        from { opacity: 0; }\n      '], ['\n        from { opacity: 0; }\n      ']),
    _templateObject12 = _taggedTemplateLiteral(['\n        from { opacity: 1; }\n      '], ['\n        from { opacity: 1; }\n      ']),
    _templateObject13 = _taggedTemplateLiteral(['animation: ', ' 1s both;'], ['animation: ', ' 1s both;']);
